                ...
                <div class="w-full">
                    <div class="mt-3 text-center">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">
                            {{ __('Delete') }} {{ $result->student->matric_number }}
                        </h3>
                        <div class="mt-2">
